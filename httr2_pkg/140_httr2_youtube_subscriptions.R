...
# ==============
{
items(snippet(title,description)),items(contentDetails(totalItemCount)
...
req  <-  request(base_url) %>% 
					...
					req_url_query(part=part, mine="true",  fields=fields, maxResults=maxResults )
...
##	WORkAROUND
##	save playlists to file; then in .Rmd (Quatro) file retrieve it and print to
##	pdf nicely.
{

saveRDS(playlists, file="playlists.rds")
